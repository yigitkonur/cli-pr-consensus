 ...
 */
export function formatAsYAML(data: PRConsensusOutput): string {
 ...
 */
function groupFilesByFolder(data: PRConsensusOutput): Record<string, FolderGroup> {
  const folders: Record<string, FolderGroup> = {};
  ...
  const sortedFolders: Record<string, FolderGroup> = {};
 ...
 */
function formatCommentCompact(comment: ParsedComment): CompactComment {
